...
object CategoryUtility {
    ...
    @JvmStatic
    val categories = setOf ("Hobby", "Concert", "Travel", "Career", "Entertainment", "Other")  //add more categories in here.

    @JvmStatic
    fun isValidCategory(categoryToCheck: String?): Boolean {
        for (category in categories)
            if (category.equals(categoryToCheck, ignoreCase = true))   return true
